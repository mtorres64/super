...
const PlanSelector = ({ planes, suscripcion, suscripcionAddons, creandoPago, whatsappNumero, accionLabel, formatCurrency, onPagar }) => {
  ...
  const priceMensualBaseOriginal = tierData?.precio_mensual_original ?? priceMensualBase;
  ...
  const totalMensualOriginal = priceMensualBaseOriginal + precioAddonsMensual;
  const totalAnualOriginal = totalMensualOriginal * 11;
  const descuentoModal = planes?.descuento_pct || 0;
              ...
              >
                ...
                <div className="p-4 flex flex-col gap-3 flex-1 relative z-10">
                  ...
                  <div className="border-t border-gray-100 pt-3 mt-auto">
                    {planes?.descuento_pct > 0 && planes?.tiers?.[key]?.precio_mensual_original != null ? (
                      <>
                        <p className="text-sm text-gray-400 line-through leading-tight">
                          {formatCurrency(planes.tiers[key].precio_mensual_original)}
                          <span className="text-xs"> / mes</span>
                        </p>
                        <p className="text-lg font-bold text-gray-900 mb-1">
                          {formatCurrency(priceMensual)}
                          <span className="text-xs font-normal text-gray-500"> / mes</span>
                        </p>
                        <span className="inline-block mb-2 px-2 py-0.5 rounded-full text-xs font-semibold bg-green-100 text-green-700">
                          {planes.descuento_pct}% OFF
                        </span>
                      </>
                    ) : (
            ...
            <div className="flex items-center justify-between px-6 pt-5 pb-4 border-b border-gray-100">
              <div>
                <div className="flex items-center gap-2 flex-wrap">
                  ...
                  {planes?.descuento_pct > 0 && (
                    <span className="inline-block px-2 py-0.5 rounded-full text-xs font-semibold bg-green-100 text-green-700">
                      {planes.descuento_pct}% OFF aplicado
                    </span>
                  )}
                </div>
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <div className="border border-gray-200 rounded-xl p-4 flex flex-col gap-3">
                  <div>
                    ...
                    {descuentoModal > 0 && totalMensualOriginal !== totalMensual && (
                      <p className="text-sm text-gray-400 line-through leading-tight mt-0.5">
                        {formatCurrency(totalMensualOriginal)}<span className="text-xs"> / mes</span>
                      </p>
                    )}
                ...
                <div className="border border-gray-200 rounded-xl p-4 flex flex-col gap-3 relative">
                  ...
                  <div>
                    ...
                    {descuentoModal > 0 && totalAnualOriginal !== totalAnual && (
                      <p className="text-sm text-gray-400 line-through leading-tight mt-0.5">
                        {formatCurrency(totalAnualOriginal)}<span className="text-xs"> / año</span>
                      </p>
                    )}
                    <p className="text-xl font-bold text-gray-900 mt-0.5">
          ...
          {loadingStatus ? (
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
              ...
              <div>
                ...
                {suscripcion.descuento_pct > 0 && planes?.tiers?.[suscripcion.plan_tier]?.precio_mensual_original != null ? (
                  <>
                    <p className="text-sm text-gray-400 line-through">
                      {formatCurrency(planes.tiers[suscripcion.plan_tier].precio_mensual_original, suscripcion.moneda)}
                      <span className="text-xs"> / mes</span>
                    </p>
                    <p className="font-semibold text-gray-900">
                      {formatCurrency(planes.tiers[suscripcion.plan_tier].precio_mensual, suscripcion.moneda)}
                      <span className="text-xs font-normal text-gray-500"> / mes</span>
                    </p>
                    <span className="inline-block mt-0.5 px-2 py-0.5 rounded-full text-xs font-semibold bg-green-100 text-green-700">
                      {suscripcion.descuento_pct}% OFF
                    </span>
                  </>
                ) : (
                  <p className="font-semibold text-gray-900">
