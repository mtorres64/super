...
import LandingSegmentadaView from './LandingSegmentadaView';
import { CONFIGS } from './segmentos';
...
export default function LandingSegmentada({ segmento }) {
